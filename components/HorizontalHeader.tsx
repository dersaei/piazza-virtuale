...
export default function HorizontalHeader() {
  ...
  const [showBevandeSub, setShowBevandeSub] = useState<{
    show: boolean;
    pathname: string;
  }>({
    show: false,
  ...
  const [showCondimentiSub, setShowCondimentiSub] = useState<{
    show: boolean;
    pathname: string;
  }>({
    show: false,
  ...
  const [forceHideState, setForceHideState] = useState<{
    hide: boolean;
    pathname: string;
  }>({
    hide: false,
  ...
  const currentShowBevandeSub =
    showBevandeSub.pathname === pathname ? showBevandeSub.show : false;
  const currentShowCondimentiSub =
    showCondimentiSub.pathname === pathname ? showCondimentiSub.show : false;
  ...
  const shouldShowBevandeSub =
    !forceHideSubcategories &&
    (currentShowBevandeSub || (!currentShowCondimentiSub && isOnBevandePage));
  const shouldShowCondimentiSub =
    !forceHideSubcategories &&
    (currentShowCondimentiSub ||
      (!currentShowBevandeSub && isOnCondimentiPage));
