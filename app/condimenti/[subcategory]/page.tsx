// app/condimenti/[subcategory]/page.tsx
...
export async function generateMetadata({
  ...
  const pageUrl = `https://piazzavirtuale.it/condimenti/${subcategory}`;
...
export default async function CondimentiSubcategoryPage({
  params,
}: {
  params: Promise<{ subcategory: string }>;
}) {
